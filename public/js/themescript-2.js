...
function myAcordion(elem,buttonsClass,divClass) {
  ...
  if (e.target.parentElement.classList.contains(buttonsClass)) {

    const target = e.target.parentElement,
      currentIndex = buttons.indexOf(target),
      currentAcordion = acordionElems[currentIndex];
    
      // console.log(currentAcordion, currentAcordions)
      
    target.classList.toggle(buttonsClass + '--active')
    currentAcordion.classList.toggle(divClass + '--active')      
